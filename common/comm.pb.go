...
const (
	...
	INDEX_TYPE_FRIEND_LIKE_SHARE_PRODUCT INDEX_TYPE = 19 //朋友喜欢/分享过的商品（时间倒排）【DESC】 LG_19_#{UserID}_DESC
	INDEX_TYPE_FRIEND_BUY_PRODUCT        INDEX_TYPE = 20 //朋友购买过的商品（时间倒排）【DESC】 LG_20_#{UserID}_DESC
)
...
var (
	INDEX_TYPE_name = map[int32]string{
		...
		18: "TOP_ALL_STATION",
		19: "FRIEND_LIKE_SHARE_PRODUCT",
		20: "FRIEND_BUY_PRODUCT",
	}
	INDEX_TYPE_value = map[string]int32{
		...
		"TOP_ALL_STATION":           18,
		"FRIEND_LIKE_SHARE_PRODUCT": 19,
		"FRIEND_BUY_PRODUCT":        20,
	}
)
...
var file_comm_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x79, 0x5f, 0x4b, 0x45, 0x45, 0x50, 0x10, 0x0d, 0x2a, 0xd2, 0x03, 0x0a, 0x0a, 0x49,
	...
	0x54, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x12, 0x12, 0x1d, 0x0a, 0x19, 0x46, 0x52, 0x49, 0x45,
	0x4e, 0x44, 0x5f, 0x4c, 0x49, 0x4b, 0x45, 0x5f, 0x53, 0x48, 0x41, 0x52, 0x45, 0x5f, 0x50, 0x52,
	0x4f, 0x44, 0x55, 0x43, 0x54, 0x10, 0x13, 0x12, 0x16, 0x0a, 0x12, 0x46, 0x52, 0x49, 0x45, 0x4e,
	0x44, 0x5f, 0x42, 0x55, 0x59, 0x5f, 0x50, 0x52, 0x4f, 0x44, 0x55, 0x43, 0x54, 0x10, 0x14, 0x42,
